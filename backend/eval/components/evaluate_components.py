...
Runs evaluations for both the query analyzer and response generator components.
"""
...
def main() -> None:
    """Run evaluations for both RAG components."""
    ...
    overall_score = (qa_scores["Overall"] + rg_scores["Overall"]) / 2
