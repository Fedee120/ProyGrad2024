# evaluates if the answer generated by the RAG is grounded against the ground truth.
...
class Groundedness(BaseModel):
    is_grounded: bool = Field(..., description="It's how grounded the answer is. If the answer is based on the facts presented, it's grounded. If it's not, it's not grounded.")
